        ...
        <>
            ...
            <Box sx={{ width: "calc(100% - 80px)", marginRight: "0px", marginLeft: "auto" }}>
                <Box className="titleHolder">
                    <Typography variant='h2' component={"h2"}>Payment</Typography>
                </Box>
                                    ...
                                    <Grid item xs={12} md={4} xl={4} lg={4}>
                                        ...
                                        <Grid container spacing={2}>
                                            <Grid items xs={12} xl={12} md={12} sm={12}>
                                                <InputField name="name" label="Sender Name" value={account.name} />
                                            </Grid>
                                            <Grid items xs={12} xl={12} md={12} sm={12}>
                                                <InputField name="senderAddress" label="Sender Address" value={account.senderAddress} />
                                            </Grid>
                                            <Grid items xs={12} xl={12} md={12} sm={12}>
                                                <InputField name="senderBankDetail" label="Sender Bank Name" value={account.senderBankDetail} />
                                            </Grid>
                                            ...
                                            <Grid items xs={12} xl={12} md={12} sm={12}>
                                                <InputField name="senderIFSC" label="Sender IFSC" value={account.senderIFSC} />
                                            </Grid>
                                            <Grid items xs={12} xl={12} md={12} sm={12}>
                                                <InputField name="senderEmail" label="Sender Email" value={account.senderEmail} />
                                            </Grid>
                                            <Grid items xs={12} xl={12} md={12} sm={12}>
                                                <BasicSelect data={data} key="id" label="Sender Country" text="text" name="senderCountry"
                            ...
                            <Box sx={{ width: "100%", padding: "60px 0px 10px" }}>
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} md={4} xl={4} lg={4}>
                                        ...
                                        <Grid container spacing={2}>
                                        <Grid items xs={12} xl={12} md={12} sm={12}>
                                                <InputField name="amount" label="Amount" value={account.amount} />
                                            </Grid>
                                            <Grid items xs={12} xl={12} md={12} sm={12}>
                                            <InputField name="discount" label="Discount (IF any)" value={account.discount} />
                                            </Grid>
                                            <Grid items xs={12} xl={12} md={12} sm={12}>
                                            <InputField name="gatewayCharge" label="Gateway Charge (IF any)" value={account.gatewayCharge} />
                                            </Grid>
                                            ...
                                            <Grid items xs={12} xl={12} md={12} sm={12}>
                                                <InputField disabled name="totalAmount" label="Total Amount" value={(account.amount+account.gatewayCharge) - account.discount } />
                                            </Grid>
                                        </Grid>
